...
You can select an active pack using the `@kanban /pack use <name>` command, or list available packs using `@kanban /pack list`.

To edit or customize these packs, modify `.agentkanban/packs.yaml` directly.
