...
![Version 1.4.0](https://img.shields.io/badge/version-1.4.0-2563eb)
...
```bash
code --install-extension agentic-kanban-1.4.0.vsix
```
...
6. Verify the new GitHub Release includes `agentic-kanban-1.4.0.vsix` and that the install command works in VS Code.
